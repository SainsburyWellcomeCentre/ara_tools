function varargout = exportMaSIVPoints(ymlPoints,fname,downSample,separateFiles)
% Export a neurite tree to a text file suitable for Lasagna or return it as a matrix
%
% function logging = exportMaSIVPoints(ymlPoints,fname,downSample,separateFiles)
%
%
% Purpose
